...
pub fn get_inventory() -> Vec<Tool> {
    let mut tools = vec![
        ...
        Tool { id: String::new(), name: "Gemini CLI".into(), binary: "gemini".into(), package: "@google/gemini-cli".into(), category: Category::Code, method: UpdateMethod::NpmPkg},
        Tool { id: String::new(), name: "OpenCode".into(), binary: "opencode".into(), package: "opencode-ai".into(), category: Category::Code, method: UpdateMethod::Opencode},
        Tool { id: String::new(), name: "Codex CLI".into(), binary: "codex".into(), package: "@openai/codex".into(), category: Category::Code, method: UpdateMethod::NpmPkg},
        Tool { id: String::new(), name: "Crush CLI".into(), binary: "crush".into(), package: "crush".into(), category: Category::Code, method: UpdateMethod::BrewPkg},
